...
export const metadata = {
  ...
  description: 'Professional social media management for businesses in India. Monthly content planning, post design, scheduling, engagement, and account growth for Instagram and Facebook. Starting from Rs.8,000/month.',
  ...
  openGraph: {
    ...
    description: 'Complete Instagram and Facebook management - content, posting, and growth. Starting from Rs.8,000/month.',
...
const service = {
  ...
  benefits: ['Consistent daily/weekly posting', 'Professional branded content', 'Hashtag strategy for reach', 'Engagement and community building', 'Monthly performance reports', 'Saves you 20+ hours per month', 'Works for Instagram, Facebook, LinkedIn', 'Starting from Rs.8,000/month'],
  faqs: [
    { q: 'How much does social media management cost?', a: 'Monthly social media management starts from Rs.8,000/month for 15 posts. Full management with reels starts from Rs.15,000/month.' },
