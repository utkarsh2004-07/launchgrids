...
export const metadata = {
  ...
  description: 'LaunchGrids builds high-converting ecommerce websites in India. Custom online stores with payment gateway, product management, order tracking, and mobile-responsive design. Starting from Rs.40,000.',
  ...
  openGraph: {
    ...
    description: 'High-converting online stores with payment gateway and order management. Starting from Rs.40,000.',
...
const service = {
  ...
  faqs: [
    { q: 'How much does an ecommerce website cost?', a: 'Ecommerce websites start from Rs.40,000 for basic stores. Feature-rich stores with custom functionality range from Rs.80,000 to Rs.2,00,000+.' },
