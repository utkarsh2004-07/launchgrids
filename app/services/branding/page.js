...
export const metadata = {
  ...
  description: 'LaunchGrids is a top branding agency in India. We create professional logos, brand identities, color palettes, typography, and complete brand guidelines for businesses and startups. Starting from Rs.15,000.',
  ...
  openGraph: {
    ...
    description: 'Professional logo design and complete brand identity for businesses in India. Starting from Rs.15,000.',
...
const service = {
  ...
  benefits: [
    ...
    'Affordable pricing starting from Rs.15,000',
  ],
  faqs: [
    { q: 'How much does logo design cost?', a: 'Logo design starts from Rs.8,000. A complete brand identity package with guidelines starts from Rs.15,000.' },
