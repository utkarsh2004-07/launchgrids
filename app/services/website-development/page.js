...
export const metadata = {
  ...
  description: 'LaunchGrids builds professional, fast, responsive business websites in India. Custom website development for small businesses, startups, clinics, salons, restaurants & ecommerce. Starting from ₹25,000.',
  ...
  openGraph: {
    ...
    description: 'Professional, fast, responsive business websites starting from ₹25,000.',
...
const service = {
  ...
  benefits: [
    ...
    'Affordable pricing starting from ₹25,000',
  ],
  faqs: [
    { q: 'How much does a website cost?', a: 'A basic business website starts from ₹25,000. The final price depends on the number of pages, features, and design complexity.' },
    ...
    { q: 'Do you provide website maintenance?', a: 'Yes, we offer monthly maintenance plans starting from ₹3,000/month including updates, backups, and support.' },
  ],
